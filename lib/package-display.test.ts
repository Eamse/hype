...
describe('parseShootDetailValue', () => {
    ...
    it('하이픈으로 된 숫자 범위를 통째로 숫자로 인식한다', () => {
        // 이 케이스가 실제로 "4.5 - 5 hours"에서 "4.5"만 큰 글씨로 나오고
        // "- 5 hours"가 작은 글씨로 잘못 표시되던 프로덕션 버그였음
...
describe('splitAddonDescIntoLines', () => {
    ...
    it('"Approx." 같은 줄임말 뒤에서 줄바꿈하지 않는다', () => {
