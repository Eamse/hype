...
export default function InquiryClient() {
    ...
    return (<section ref={ctaRef} className="inquiry-cta">
      ...
      <div className="inquiry-cta-buttons">
        <a href={WEDDING_FORM_URL} target="_blank" rel="noopener noreferrer" className="inquiry-btn inquiry-btn--filled inquiry-rise" data-reveal data-reveal-delay="440">
          HYPE WEDDING
          <ArrowRight size={16} strokeWidth={2.5}/>
        </a>
        <a href={SNAP_FORM_URL} target="_blank" rel="noopener noreferrer" className="inquiry-btn inquiry-btn--outline inquiry-rise" data-reveal data-reveal-delay="440">
          HYPE SNAP
          <ArrowRight size={16} strokeWidth={2.5}/>
        </a>
      </div>

      <div className="inquiry-fade" data-reveal data-reveal-delay="560" style={{ marginTop: 56, textAlign: 'center' }}>
        <p style={{
            fontSize: 26,
            fontWeight: 700,
            marginBottom: 10,
        ...
        <div style={{
          ...
          <ContactButton href={WHATSAPP_URL} label="Whatsapp" icon="/icons/sns/whatsapp.svg"/>
          <ContactButton href={WECHAT_URL} label="Wechat" icon="/icons/sns/wechat.svg"/>
          <ContactButton href={LINE_URL} label="Line" icon="/icons/sns/line.png"/>
        </div>
      </div>
    </section>);
}
function ContactButton({ href, label, icon, }: {
    href: string;
    label: string;
    icon: string;
}) {
