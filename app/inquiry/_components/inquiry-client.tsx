...
function StepCard({
  ...
  return (
    <div style={{ flex: 1, minWidth: 0 }}>
      ...
      >
        STEP {num} | <span style={{ fontWeight: 800 }}>{step.title}</span>
        {step.tag && (
          <span
            style={{
              fontSize: 12,
    ...
    <>
      ...
      <section
        style={{
          ...
          textAlign: 'center',
          padding: isMobile ? '10px 24px' : '10px 40px',
      ...
      <section
        style={{
          ...
          padding: isMobile ? '60px 24px 80px' : '80px 60px 100px',
        }}
      >
        <p
          style={{
