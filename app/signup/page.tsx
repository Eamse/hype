      ...
      <div className="bg-white w-full max-w-2xl rounded-2xl shadow-sm p-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input type="password" name="password" value={credentials.password} onChange={handleCredentialChange} placeholder="••••••••" className={`w-full border rounded-lg px-3 py-2 text-sm outline-none ${errors.password ? 'border-red-400' : 'border-gray-200 focus:border-gray-900'}`}/>
            {errors.password ? (<p className="text-xs text-red-500">{errors.password}</p>) : (<p className="text-xs text-gray-400">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input type="password" name="passwordConfirm" value={credentials.passwordConfirm} onChange={handleCredentialChange} placeholder="••••••••" className={`w-full border rounded-lg px-3 py-2 text-sm outline-none ${errors.passwordConfirm ? 'border-red-400' : 'border-gray-200 focus:border-gray-900'}`}/>
            {errors.passwordConfirm && (<p className="text-xs text-red-500">{errors.passwordConfirm}</p>)}
          </div>

          
          <UserInfoFields values={userInfo} errors={errors} phoneValue={phoneValue} onChange={handleFieldChange} onPhoneChange={handlePhoneChange}/>
          ...
          <div className="flex flex-col gap-3">
            ...
            <button type="button" onClick={() => signIn('google', { callbackUrl: '/onboarding' })} className="flex items-center justify-center gap-3 w-full border border-gray-200 rounded-xl py-3 text-sm font-medium text-gray-800 hover:bg-gray-50 transition-colors">
              <GoogleIcon />
