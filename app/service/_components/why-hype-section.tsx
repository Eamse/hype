...
const ITEMS = [
  {
    title: 'Photographers',
    subtitle: "Korea's most in-demand photographers",
  },
  {
          ...
          return (
            <div key={item.title} className="offer-item">
              <h3
                ...
                className="offer-item-title type-section-header offer-rise"
              >
                {item.title}
              </h3>
              <p
                ...
                className="offer-item-subtitle type-body offer-fade"
              >
                {item.subtitle}
              </p>
            </div>
