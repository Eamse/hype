...
export async function GET(_: NextRequest, props: {
    ...
    try {
        ...
        console.error('[GET /api/products/:id]', e instanceof Error ? e.message : e);
...
export async function PATCH(request: NextRequest, props: {
    ...
    try {
        ...
        console.error('[PATCH /api/products/:id]', e instanceof Error ? e.message : e);
        return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
    }
}
export async function DELETE(request: NextRequest, props: {
    ...
    try {
        ...
        console.error('[DELETE /api/products/:id]', e instanceof Error ? e.message : e);
        return NextResponse.json({ error: 'Internal server error' }, { status: 500 });
    }
}
