    ...
    return (<div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <main style={{ paddingTop: 56, flex: 1 }}>
        <div style={{
          ...
          <ReviewFeatured reviews={featuredReviews.map((review) => ({
            id: review.id,
            name: maskName(review.name),
            country: review.country,
            productType: review.productType,
          ...
          <div style={{
            ...
            <div>
              <Suspense fallback={null}>
                <ReviewFilters productType={productType} location={location} directorId={directorId}/>
              </Suspense>
            ...
            if (directorId)
                params.set('directorId', directorId);
