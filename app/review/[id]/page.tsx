    ...
    return (<div style={{ minHeight: '100vh' }}>
      ...
      <main style={{ paddingTop: 56 }}>
        <div style={{ maxWidth: 800, margin: '0 auto', padding: '40px 20px 80px' }}>
          <Link href="/review" className="mb-4 inline-flex items-center gap-1 text-[13px] font-medium text-[#666] no-underline hover:text-[#111]">
            ← Back to Reviews
          </Link>
          <div className="rounded-2xl border border-[#eee] bg-white p-6 sm:p-8">
            <div className="mb-5 flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                <div className="mb-1 flex flex-wrap items-center gap-1.5">
                  <span className={`rounded-full px-2 py-[2px] text-[10px] font-semibold uppercase tracking-wide ${review.location === 'jeju'
            ...
            {review.images.length > 0 && (<div style={{
                ...
                {review.images.map((img) => (<div key={img.id} className="relative w-full overflow-hidden rounded-xl" style={{ aspectRatio: '1' }}>
