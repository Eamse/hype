...
export default function ReviewFeatured({ reviews, }: {
    reviews: FeaturedReview[];
}) {
    const ref = useRef<HTMLDivElement>(null);
    useReplayReveal(ref);
    return (<div ref={ref} style={{ marginBottom: 48 }}>
      <p className="review-fade" data-reveal data-reveal-delay="0" style={{
            fontSize: 15,
            fontWeight: 700,
      ...
      <h1 className="review-fade type-hero-display" data-reveal data-reveal-delay="80" style={{
            fontWeight: 800,
      ...
      <p className="review-fade type-body" data-reveal data-reveal-delay="140" style={{ color: '#555', marginBottom: 28 }}>
        Real stories from real couples
      </p>

      {reviews.length > 0 && (<>
          <p className="review-fade" data-reveal data-reveal-delay="200" style={{
                fontSize: 20,
                fontWeight: 800,
                color: '#2d5a45',
          ...
          <div style={{
            ...
            {reviews.map((review, i) => (<Link key={review.id} href={`/review/${review.id}`} className="review-rise" data-reveal data-reveal-delay={`${260 + i * 100}`} style={{
                    display: 'block',
