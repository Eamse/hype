    ...
    return (<div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
      ...
      <div style={{ background: '#fff', border: '1px solid #000', borderRadius: 12, padding: 24 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 2fr', gap: 12, marginBottom: 16 }}>
          ...
          <div>
            ...
            <input style={inputStyle} placeholder="@instagram" value={form.instagram} onChange={(e) => setForm((f) => ({ ...f, instagram: e.target.value }))}/>
          </div>
        </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
        ...
        {partners.map((p) => (<div key={p.id} style={{ background: '#fff', border: '1px solid #000', borderRadius: 10, padding: '16px 20px', display: 'flex', alignItems: 'flex-start', gap: 12 }}>
            ...
            <div style={{ flex: 1 }}>
            {editingId === p.id ? (<div style={{ display: 'grid', gridTemplateColumns: '2fr 2fr', gap: 12 }}>
