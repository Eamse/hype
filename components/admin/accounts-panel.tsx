...
export default function AccountsPanel() {
    ...
    return (<div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
      ...
      <div style={{
        ...
        <div style={{ padding: '20px 24px', borderBottom: '1px solid #fff' }}>
          <p style={{
            fontSize: 11,
            color: '#5a5a5a',
            fontWeight: 700,
        ...
        {loading ? (<p style={{ color: '#000', fontSize: 14, padding: 24 }}>
            불러오는 중...
            ...
            <table style={{
              ...
              <tbody>
                {accounts.map((a) => (<tr key={a.id} style={{ borderTop: '1px solid #fff' }}>
                    <td style={{
                    padding: '14px 16px',
                    fontWeight: 600,
                    color: '#000',
                    ...
                    <td style={{ padding: '14px 16px' }}>
                      <span style={{
                    background: a.role === 'master' ? '#f4f4f4' : '#efefef',
                    ...
                    <td style={{ padding: '14px 16px' }}>
                      {a.locked ? (<span onClick={() => a.role !== 'master' && handleUnlock(a.id)} title={a.role === 'master'
                        ? undefined
                        : '클릭하여 잠금 해제'} style={{
                        background: '#ececec',
                        color: '#575757',
                        ...
                        textDecoration: a.role === 'master' ? 'none' : 'underline',
                    }}>
                          Locked
                        </span>) : (<span style={{ fontSize: 11, color: '#000' }}>—</span>)}
                    </td>
                    <td style={{
                    padding: '14px 16px',
                    color: '#000',
                    ...
                    <td style={{ padding: '14px 16px' }}>
                      <button onClick={() => handleDelete(a.id)} style={btnStyle('#fff', '#7f7f7f', '#7f7f7f')}>
                        Delete
                      </button>
                    </td>
                  </tr>))}
